...
fileDimensionality <-paste("results/tsms-",typeDimensionality,".rds",sep="")
fileTrain <-paste("results/tsms-tokens-", typeDimensionality, "-", model, "-train-", k, "-folds.rds", sep="")
fileTest <- paste("results/tsms-tokens-", typeDimensionality, "-", model, "-test-", k, "-folds.rds", sep="")
...
#TSMS
{
  ...
  cat("Finished ",model, " TSMS...\n")
  saveRDS(tsms.nb.trained, file = fileTrain)
  saveRDS(tsms.nb.cf, file = fileTest)
}
}
}
}
