...
#YTBID
{
  ...
  saveRDS(ytbid.rf.trained, file = paste("results/ytbid-tokens-",technique,"-rf-train.rds",sep=""))
  saveRDS(ytbid.rf.cf, file = paste("results/ytbid-tokens-",technique,"-rf-test.rds",sep=""))
}
}
