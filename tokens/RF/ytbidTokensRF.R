...
#YTBID
{
  ...
  saveRDS(ytbid.rf.trained, file = paste("resultsWithOutSteps/ytbid-tokens-",technique,"-rf-train.rds",sep=""))
  saveRDS(ytbid.rf.cf, file = paste("resultsWithOutSteps/ytbid-tokens-",technique,"-rf-test.rds",sep=""))
}
}
