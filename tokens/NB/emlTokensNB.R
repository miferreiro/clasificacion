...
#EML
{
  ...
  cat("Finished NB EML...\n")
  saveRDS(eml.nb.trained, file = paste("results/eml-tokens-",technique,"-nb-train.rds",sep=""))
  saveRDS(eml.nb.cf, file = paste("results/eml-tokens-",technique,"-nb-test.rds",sep=""))
}
}
